...
app.factory('editNeed', function($http, $rootScope) {
...
app.factory('getEndingVariant', function() {
...
app.factory('updateExs', function($rootScope, extendedSkills, appendProgressToExs) {
